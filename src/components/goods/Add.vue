        ...
        <el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-width="100px" label-position="top">
            <el-tabs v-model="activeIndex" tab-position="left" :before-leave="beforeTabLeave" @tab-click="tabClicked">
                ...
                <el-tab-pane label="商品图片" name="3">
                    ...
                    <el-upload :action="uploadURL" :on-preview="handlePreview" :on-remove="handleRemove" list-type="picture" :headers="headerObj" :onSuccess="handleSuccess">
...
export default {
    data() {
        return {
            ...
            onlyTableData: [],
            // 上传图片的URL地址
            uploadURL: 'http://www.violateer.top:12345/api/private/v1/upload',
            // 图片上传组件的请求头对象
            headerObj: {
    ...
    methods: {
        ...
        async tabClicked() {
            ...
            if (this.activeIndex === '1' || this.activeIndex === '2') {
                const {
                    ...
                    params: {
                        sel: this.activeIndex === '1' ? 'many' : 'only'
                    }
                })
                if (res.meta.status !== 200) {
        ...
        // 预览图片
        handlePreview(file) {
            this.previewPath = 'http://www.violateer.top:12345' + file.response.data.url.slice(21)
            this.previewVisible = trued
        },
        // 点击x号删除图片
        handleRemove(file) {
            // 获取要删除的图片的临时路径
