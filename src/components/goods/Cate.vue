...
<div>
    ...
    <el-dialog title="修改分类" :visible.sync="editCateDialogVisible" width="50%" @close="editCateDialogClosed">
        <el-form ref="editCateFormRef" :model="editCateForm" :rules="editCateFormRules" label-width="70px">
    ...
    <!-- 删除分类的对话框 -->
    <el-dialog title="删除分类" :visible.sync="editCateDialogVisible" width="50%" @close="editCateDialogClosed">
        <el-form ref="editCateFormRef" :model="editCateForm" :rules="editCateFormRules" label-width="70px">
            <el-form-item label="分类名称" prop="cat_name" label-width="80px">
                <el-input v-model="editCateForm.cat_name"></el-input>
            </el-form-item>
...
export default {
    ...
    methods: {
        ...
        parentCateChange() {
            ...
            // selectedKeys数组中的length大于0， 说明选中了父级分类，反之没有选中任何父级分类
